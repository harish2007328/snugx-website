...
const Index = () => {
  ...
  return <div className="min-h-screen">
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 pt-20 bg-[11111111] bg-inherit">
        ...
        <div className="max-w-7xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-neon-green text-dark-bg hover:bg-neon-green/80 font-semibold px-8 py-4 text-lg rounded-full neon-glow-strong group" asChild>
              <Link to="/contact">
                Get Your Free Quote
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="border-white/20 text-light-text hover:bg-white/10 px-8 py-4 text-lg rounded-full glass" asChild>
      ...
      <section ref={statsRef} className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => <Card key={index} className="glass text-center p-6 hover:glass-strong transition-all">
      ...
      <section ref={servicesRef} className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => <Card key={index} className="glass hover:glass-strong transition-all duration-300 group">
                <CardContent className="p-8 text-center">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, idx) => <li key={idx} className="flex items-center justify-center space-x-2 text-sm text-gray-400">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-neon-green/5 to-transparent">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <Button size="lg" className="bg-neon-green text-dark-bg hover:bg-neon-green/80 font-semibold px-8 py-4 rounded-full" asChild>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="glass">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-neon-green/10 to-transparent">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-neon-green text-dark-bg hover:bg-neon-green/80 font-semibold px-8 py-4 text-lg rounded-full neon-glow-strong" asChild>
