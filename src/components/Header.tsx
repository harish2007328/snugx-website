      ...
      <nav className="glass-strong rounded-full px-6 py-4 mx-auto">
        <div className="flex items-center justify-between">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`text-sm font-medium transition-colors hover:text-neon-green ${
                  location.pathname === item.path ? 'text-neon-green' : 'text-light-text'
                }`}
              >
                {item.name}
              </Link>
          ...
          <div className="hidden md:block">
            <Button 
              className="bg-neon-green text-dark-bg hover:bg-neon-green/80 font-semibold px-6 py-2 rounded-full neon-glow"
              asChild
            >
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-light-text hover:text-neon-green transition-colors"
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-white/10">
            <div className="flex flex-col space-y-4">
              ...
              <Button 
                className="bg-neon-green text-dark-bg hover:bg-neon-green/80 font-semibold rounded-full w-full mt-4"
                asChild
              >
